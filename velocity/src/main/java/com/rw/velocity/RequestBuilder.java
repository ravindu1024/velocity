...
public class RequestBuilder
{
    ...
    ArrayList<Pair<String, String>> pathParams = new ArrayList<>();
    String rawParams;
    ...
    {
        this.pathParams.add(new Pair<>(key, value));
        return this;
    }
    ...
    public RequestBuilder withPathParams(HashMap<String, String> pathParams)
    {
        for(Map.Entry<String, String> entry: pathParams.entrySet())
            this.pathParams.add(new Pair<>(entry.getKey(), entry.getValue()));
    ...
    private String getPathParams()
    {
        ...
        {
            for (Pair<String, String> p : pathParams)
            {
